...
1. 打开资产列表 → **新建资产** / **落点管理** 维护主数据  
2. 进入资产 → **管理流向** 维护 flow → path → step  
3. 或点击「一键成图」查看可视化；在连线详情可跳转「编辑流向」  
4. 对 201 打开「含辅助」开关，查看通知通道辅助流向  
4. 对 204 / 403 查看底部「相关派生/加工」及流向图  
5. 对 400/401/402 分别看推送+跨区同步；对 403 默认看本资产 SFTP→主题F，打开「含前置」叠加三主题输入链路与派生桥接  
